...
#pragma warning restore CS0612
    ...
    {
        var grpc = new Grpc.GetCompactionStateResponse { State = Grpc.CompactionState.Executing };
    ...
    {
        var resp = new OptimizeResp(123, "512");
    ...
    {
        var resp = new OptimizeResp(null, null);
    ...
    {
        var grpc = new Grpc.PersistentSegmentInfo { SegmentID = 1, CollectionID = 2, NumRows = 100 };
