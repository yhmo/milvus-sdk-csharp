...
public class DmlReqTests
{
    ...
    public void Insert_maps_collection_partition_and_row_count()
    {
        var request = new InsertReq
        {
            CollectionName = "book",
            PartitionName = "p1",
            Data = new[] { FieldData.Create("id", new long[] { 1, 2, 3 }) }
        };
    ...
    public void Insert_defaults_partition_to_empty_string()
    {
        ...
        {
            CollectionName = "book",
            Data = new[] { FieldData.Create("id", new long[] { 1 }) }
        };
    ...
    public void Insert_serializes_json_field()
    {
        ...
        {
            CollectionName = "book",
            Data = new[] { FieldData.CreateJson("meta", new[] { "{\"a\":1}", "{\"a\":2}" }) }
        };
    ...
    public void Insert_serializes_nullable_scalar_with_valid_data()
    {
        ...
        {
            CollectionName = "book",
            Data = new[] { FieldData.Create<int?>("score", new int?[] { 1, null, 3 }) }
        };
    ...
    public void Insert_aggregates_only_dynamic_fields_into_single_meta_json()
    {
        ...
        {
            CollectionName = "book",
            Data = new[] { FieldData.Create("x", new long[] { 5 }, isDynamic: true) }
        };
    ...
    public void Upsert_maps_collection_partition_and_row_count()
    {
        var request = new UpsertReq
        {
            CollectionName = "book",
            PartitionName = "p1",
            Data = new[] { FieldData.Create("id", new long[] { 1, 2 }) }
        };
