...
public class UtilityMoreReqTests
{
    ...
    {
        Grpc.FlushAllRequest grpc = FlushAllReq.ToGrpcFlushAllRequest();
        Assert.NotNull(grpc);
    }
...
#pragma warning restore CS0612
    ...
    {
        var request = new GetPersistentSegmentInfoReq { CollectionName = "coll" };
    ...
    {
        var request = new GetQuerySegmentInfoReq { CollectionName = "coll" };
