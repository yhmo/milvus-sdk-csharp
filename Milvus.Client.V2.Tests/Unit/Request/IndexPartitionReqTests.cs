...
public class IndexPartitionReqTests
{
    ...
    public void CreateIndex_maps_fields_index_type_metric_type_and_extra_params()
    {
        ...
        request.ExtraParams["nlist"] = "1024";
        request.ExtraParams["M"] = "32";

        Grpc.CreateIndexRequest grpc = request.ToGrpcCreateIndexRequest();
    ...
    {
        var request = new CreateIndexReq { CollectionName = "book", FieldName = "embedding" };
    ...
    {
        var request = new CreateIndexReq { CollectionName = " ", FieldName = "embedding" };
        Assert.Throws<ArgumentException>(() => request.ToGrpcCreateIndexRequest());
    }

    [Fact]
    public void CreateIndex_throws_when_field_blank()
    {
        var request = new CreateIndexReq { CollectionName = "book", FieldName = " " };
        Assert.Throws<ArgumentException>(() => request.ToGrpcCreateIndexRequest());
    }
