...
public sealed class SearchParameters
{
    ...
    /// </summary>
    /// <remarks>
    /// Only takes effect with <see cref="ConsistencyLevel.BoundedStaleness" />; the server delays the query by
    /// this amount to wait for data visibility.
    /// </remarks>
    ...
    /// (e.g. "L2 &lt;= 0.6"); the combination is only honored by range-search-enabled index types.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// Combined with <see cref="Radius" /> to define the accepted distance interval (e.g.
    /// "0.2 &lt;= L2 &lt;= 0.6"); range-search-enabled index types are required.
    /// </remarks>
