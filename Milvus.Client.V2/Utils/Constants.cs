...
internal static class Constants
{
    ...
    /// <summary>
    /// Key name in type params. Indicates whether match (BM25 keyword) search is enabled for a varchar field.
    /// </summary>
    internal const string EnableMatch = "enable_match";

    /// <summary>
    /// Key name in type params. Contains the multi-language analyzer parameters as JSON.
    /// </summary>
    internal const string MultiAnalyzerParams = "multi_analyzer_params";
    ...
    /// <summary>
    /// Key name in load parameters.
    /// </summary>
    internal const string LoadPriority = "load_priority";
