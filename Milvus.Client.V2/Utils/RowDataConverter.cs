    ...
    private static FieldData BuildColumn(FieldSchema field, List<object?> values)
    {
        switch (field.DataType)
        {
            ...
            case DataType.Geometry:
                // Geometry row values travel as GeoJSON/WKT strings in the string_data slot; the field is not
                // nullable, so a null value is rejected like the other scalar branches.
