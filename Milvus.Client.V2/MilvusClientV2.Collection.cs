...
public sealed partial class MilvusClientV2
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (request.Dimension <= 0)
        {
            throw new ArgumentOutOfRangeException(nameof(request), request.Dimension,
                "Dimension must be specified and greater than zero.");
        }
    ...
    private void InvalidateCollectionCaches(string collectionName)
    {
        ...
        SchemaCache.Instance.TryGetResolvedCollectionName(_endpoint, CurrentDatabase, collectionName, out string? canonical);
