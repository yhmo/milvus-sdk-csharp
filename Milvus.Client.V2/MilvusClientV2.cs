...
public sealed partial class MilvusClientV2 : IDisposable
{
    ...
    // dbname metadata header under _connectLock; readers must go through this property (and CreateCallOptions)
    // so a concurrent database switch cannot split the header and the cache key across two databases.
