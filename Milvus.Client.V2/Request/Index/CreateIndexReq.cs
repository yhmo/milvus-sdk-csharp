...
public sealed class CreateIndexReq
{
    ...
    /// <summary>
    /// The index type. When unset, the index type is omitted from the request and the server picks its
    /// default (for vector fields this is typically AUTOINDEX).
    /// </summary>
    ...
    /// <summary>
    /// The maximum time in milliseconds to wait for the index to build when <see cref="Sync" /> is enabled.
