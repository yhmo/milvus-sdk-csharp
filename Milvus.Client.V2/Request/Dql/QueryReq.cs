...
public sealed class QueryReq
{
    ...
    /// </summary>
    /// <remarks>
    /// Mutually exclusive with <see cref="QueryParameters.Ids" />; setting both, or neither, throws
    /// <see cref="ArgumentException" /> at request time. For parameterized expressions, placeholders such as
    /// <c>"age &gt; {minAge}"</c> can be filled with <see cref="QueryParameters.FilterTemplates" />.
    /// </remarks>
